...
const unfundedDesc = totalUnfunded > 1 ? `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${totalUnfunded} games remain unfunded. We need your help to fun these amazing games!`
: `A total of $ ${totalRaised} has been raised for ${GAMES_JSON.length} games. Currently, ${totalUnfunded} game remains unfunded. We need your help to fun these amazing games!` ;

// create a new DOM element containing the template string and append it to the description container
const newDesc = document.createElement("p");
newDesc.innerHTML = unfundedDesc;
descriptionContainer.appendChild(newDesc);
